...
let items = [
  {
    ...
    BusType: "Ordinary",
    Destination:
      "South Bus Terminal - Talisay, City of Naga, San Fernando, Sibonga, Argao, Dalaguete, Alcoy, Boljoon, Oslob, Santander",
  ...
  },
  {
    ...
    BusType: "Aircon",
    Destination:
      "Southbus Terminal - Talisay, City of Naga, San Fernando, Barili, Dumanjug, Badian, Samboan, Bato",
  ...
  },
  {
    ...
    BusType: "Aircon",
    Destination:
      "Southbus Terminal - Talisay, City of Naga, San Fernando, Sibonga, Argao",
    DepartureTime: "04:00 AM",
    ArrivalTime: "06:00 AM",
    NumberOfBuses: "3",
    Seats: "45 Seaters"
  ...
  },
  {
    ...
    BusType: "Aircon",
    Destination:
      "Southbus Terminal - Talisay, City of Naga, San Fernando, Sibonga, Argao, Dalaguete, Alcoy ",
    DepartureTime: "1:00 AM",
    ArrivalTime: "12:00 Mid",
    NumberOfBuses: "5",
    Seats: "45 Seaters"
  ...
  },
  {
    ...
    BusType: "Aircon",
    Destination:
      "Southbus Terminal - Talisay, City of Naga, San Fernando, Barili, Dumanjug, Badian, Samboan",
    DepartureTime: "4:00 AM",
    ArrivalTime: "8:30 PM",
    NumberOfBuses: "3",
    Seats: "56 Seaters"
  },
  {
    ...
    BusType: "Aircon",
    Destination:
      "Southbus Terminal - Talisay, City of Naga, San Fernando, Sibonga, Argao, Dalaguete, Alcoy, Boljoon, Oslob, Santander",
    DepartureTime: "4:00 AM",
    ArrivalTime: "8:30 PM",
    NumberOfBuses: "6",
    Seats: "56 Seaters"
...
app.post("/user/profile", (req, res) => {
  ...
  User.findByIdAndUpdate(
    ...
    (err, user) => {
      if (err) {
        res.status(500).send({ error: "error", timestamp: new Date() });
      } else {
        res.send(user);
      }
    }
